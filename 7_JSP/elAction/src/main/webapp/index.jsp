...
<body>
    ...
    <!-- 만약 자바스크립트 문법으로서 ${name}같이 쓰고 싶다면 자바스크립트 코드 파일을 따로 만들어줘야한다. 그렇지 앟고 그냥 jsp파일에 쓰면 컴퓨터는 무조건 el로 해석한다. -->

    <h1>JSP Action Tag</h1>
    <%--
        *JSP를 이루는 구성
        1. 스크립팅원소 : jsp 페이지 내에서 자바코드를 직접기술할 수 있게 하는 기술
            ex) 스크립틀릿, 표현식...

        2. 지시어 : JSP페이지 정보에 대한 내용을 표현한다거나 또 다른페이지를 포함할 때 사용(page, include)
                    JSP 기능을 확장시키는 라이브러리를 등록할 때 사용(taglib)
