...
public class MusicView {
	...
	public void searchMusic() {
		...
		if(mc.searchMusic(title) != null) {
			...
			System.err.println("검색한 곡이 존재하지 않습니다. 메인으로 돌아갑니다.\n");
		}
	}
	...
	public void removeMusic() {
		...
		if(mc.removeMusic(title) != null) {
			...
			System.err.println("해당 곡이 존재하지 않습니다. 메인으로 돌아갑니다.\n");
		}
	}
	...
	public void setMusic() {
		...
		if(mc.searchMusic(searchtitle) != null) {
			...
			mc.setMusic(title, new Music(title, singer));
			System.out.println("성공적으로 수정되었습니다.\n");
		}
		else {
			System.err.println("존재하지 않는 곡입니다. 메인으로 돌아갑니다.\n");
		}
	}
