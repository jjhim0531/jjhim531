...
public class Run {
	/*
	 	...
	 	* 스트림 : 입출력 장치에서 데이터를 읽고 쓰기 위해 자바에서 제공하는 클래스.
	 			 (이렇게 제공되는 것들을 내장패키지라고 함.)
	 	 		 모든 스트림은 단방향.
