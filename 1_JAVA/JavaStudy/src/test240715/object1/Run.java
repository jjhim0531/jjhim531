...
public class Run {
	...
	public static void main(String[] args) {
		...
		*/
		...
		// 번호(1~20)까지를 무작위로 10번을 입력받는다.
		// 입력받은 1~20까지의 수가 각각 몇 번 입력되었는지를 출력한다.
		...
		/*
			...
			//배열의 각 인덱스는 숫자 1부터 20까지의 입력 횟수를 기록.
			//	예: arr[0]는 숫자 1의 입력 횟수를, arr[1]은 숫자 2의 입력 횟수를 기록.
			
			System.out.print("입력 : ");
			for(int i=0; i < 10; i++) {
				int num = sc.nextInt();
				arr[num - 1]++; // 입력된 숫자의 카운트 증가
			}
		...
		*/
		...
		//각 필드 데이터의 getter/setter, 기본생성자, 모든 필드데이터를 초기화하는 생성자를 작성하고
