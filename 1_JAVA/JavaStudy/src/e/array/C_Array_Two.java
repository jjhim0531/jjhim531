...
public class C_Array_Two {
	...
	public static void main(String[] args) {
		/*
		 * 1. 2차원 배열선언(1차원 배열의 묶음을 참조하는 2차원배열 참조변수를 만든다)
		 * 자료형[][] 배열명;
		 * 
		 */
...
//		int[][] arr;
		 ...
		 *  
		 */
//		arr = new int[3][4];//길이가 4개짜리인 1차원 배열 3개묶음 생성
//		arr = new int[3][];//1차원 배열(아직 길이 지정 안함) 3개묶음 생성
//		arr[0] = new int[4];
//		arr[1] = new int[4];
//		arr[2] = new int[4];
		...
		*/
		...
		//3행 3열짜리 문자열 배열을 선언하고 0행 0열부터 2행 2열까지 차례때로 접근하여 (행,열) 값을 저장하기
